...
"SELECT users.name, CAST(SUM(pledges.amount) AS INT) FROM users INNER JOIN pledges ON users.id = pledges.user_id GROUP BY users.name ORDER BY pledges.amount;"
end
